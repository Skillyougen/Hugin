...
- Protocoles guidés réécrits avec des gestes précis, durées, contrôles et critères d'aggravation, et séparés en cas haut/bas (tachycardie/bradycardie, hyperthermie/hypothermie). Contenu illustratif : ce sont des consignes de premiers secours courantes simplifiées, à faire relire par un professionnel avant tout usage réel.
